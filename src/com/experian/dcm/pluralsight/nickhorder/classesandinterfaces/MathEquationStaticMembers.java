...
public class MathEquationStaticMembers {
    ...
    public MathEquationStaticMembers() {}
    public MathEquationStaticMembers(char opCode){
        this.opCode = opCode;
    }
    public MathEquationStaticMembers(char opCode, double leftVal, double rightVal){
